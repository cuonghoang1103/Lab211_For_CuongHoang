...
/**
 * REPOSITORY: holds the data of the program - the array of numbers the service sorts and
 * searches - and only simple CRUD on it. No sorting, no searching, no print.
 *
 * @author HE176322
 */
