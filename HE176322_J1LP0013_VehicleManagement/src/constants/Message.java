...
public final class Message {
    ...
    // ----- menus -----
    // Main menu: one line per function of the brief, then Quit.
    ...
    public static final String ADD_MENU = "\n===== ADD NEW VEHICLE =====\n"
            ...
            + "3. Back to main menu\n"
            + "===========================";
    // Sub menu of Function 5.
    public static final String SEARCH_MENU = "\n===== SEARCH VEHICLE =====\n"
            + "1. Search by name\n"
            + "2. Search by id\n"
            + "3. Back to main menu\n"
            + "==========================";
    // Sub menu of Function 6.
    ...
    public static final String ASK_DELETE = "Delete this vehicle? (Y/N): ";
    // Asked at Quit only when something was changed and not stored.
    public static final String ASK_STORE
            = "There are unsaved changes. Store them before quitting? (Y/N): ";
    ...
    // Function 1 skipped bad lines; %d is how many.
    public static final String LOAD_SKIPPED = "%d damaged line(s) were ignored.";
    // Function 2 done.
