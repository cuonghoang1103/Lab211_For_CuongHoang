"""Keystroke runs for J1.S.P0001 (bubble sort).

REPLACE_REFERENCE: the reference transcript printed "Please input the number
of array: " while the brief's screen shows "Enter number of array:" on its own
line - the brief wins, so only these runs count.
...
RUNS = [
    ...
    ("1\n", screen(1, [])),
    # biggest legal array: the swapped-flag loop must still finish fast
    ("1000\n", screen(1000, [])),
