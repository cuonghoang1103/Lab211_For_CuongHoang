"""Keystroke runs for J1.S.P0004 (quick sort).

REPLACE_REFERENCE: the reference transcript printed a title line
"===== Quick Sort Program =====" and the prompt "Please input the number of array: "
...
RUNS = [
    ...
    ("1\n", screen(1, [])),
    # two elements: the smallest array the quick sort really has to work on
    ("2\n", screen(2, [])),
