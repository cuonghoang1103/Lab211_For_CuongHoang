"""Keystroke runs for J1.S.P0002 (selection sort).

REPLACE_REFERENCE: the reference transcript printed a title line
"===== Selection Sort Program =====" and the prompt "Please input the number of array: "
...
RUNS = [
    ...
    ("1\n", screen(1, [])),
    # two elements: the smallest array the selection sort really has to work on
    ("2\n", screen(2, [])),
