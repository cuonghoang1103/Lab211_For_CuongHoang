...
public final class Message {
    ...
    // ----- menu -----
    // Main screen of the brief, word for word (the brief starts the last sentence with a
    // space).
    ...
    // ----- search -----
    // Search prompt for the name (the brief's wording); the brief leaves an empty line
    // between the names and this question.
    ...
    // Title above the search result (the brief's wording, after an empty line like the
    // brief).
    public static final String FOUND_TITLE = "\nThe candidates found:";
