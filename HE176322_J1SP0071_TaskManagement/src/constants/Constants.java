...
public final class Constants {
    ...
    // The "Time" column: the hours of the task, one decimal (the brief: 9.5 to 17.5 is 8.0).
    ...
    // A task as one short line in the debugger: ID, requirement name, type name.
    public static final String TASK_TEXT_FORMAT = "%d %s %s";
