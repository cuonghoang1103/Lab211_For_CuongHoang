...
public final class Message {
    ...
    // The name line; %s is the name.
    public static final String LABEL_NAME = "Name:%s";

    // The class line; %s is the class.
    public static final String LABEL_CLASSES = "Classes:%s";

    // The average line; %s is the average with one decimal.
    public static final String LABEL_AVG = "AVG:%s";

    // The type line; %s is A, B, C or D.
