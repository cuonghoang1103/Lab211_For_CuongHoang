...
public final class Constants {
    ...
    public static final String[] TYPE_ARRAY = {TYPE_A, TYPE_B, TYPE_C, TYPE_D};
    ...
    // Text of a student for toString(): name (class) average type.
    public static final String STUDENT_FORMAT = "%s (%s) %s %s";
