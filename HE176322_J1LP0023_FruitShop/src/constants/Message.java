...
public final class Message {
    ...
    // Blank line, then the brief's main screen with the sentence under the options (the
    // brief starts that sentence with a space).
    ...
    // Header of the cart (the brief writes it with one space in front).
    public static final String CART_HEADER = " Product | Quantity | Price | Amount";

    // Header of every saved order (the brief's View orders).
