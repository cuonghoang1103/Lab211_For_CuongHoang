...
public final class Constants {
    ...
    // An amount with the dollar sign after it, like the brief's "2$".
    public static final String MONEY_FORMAT = "%s$";
    ...
    // One row of the cart, one space in front like the brief: product, quantity, price,
    // amount.
