...
| # | File | Để làm gì |
|---|---|---|
| 1 | [`QUY-TAC-THAY.md`](QUY-TAC-THAY.md) | Luật của thầy — **mỗi dòng có nguồn nguyên văn** |
| 2 | [`CACH-REVIEW.md`](CACH-REVIEW.md) | 5 cửa review, ngân hàng câu hỏi vấn đáp, debug, checklist |
| 3 | `HE176322_J1SP0055_DoctorManagement/` | **Bài thầy bắt làm buổi 1** — khuôn cho mọi bài |
| 4 | `HE176322_J1SP0001_BubbleSort/` | Khuôn cho bài thuật toán nhỏ: MVC + Facade, **không thêm lớp pattern thừa** |
...
| LOC | Mã | Đề | Độ khó | Package | File | Pattern thêm | Hướng dẫn |
|---|---|---|---|---|---|---|---|
| 21 | `J1.S.P0060` | [Calculate the total amount spent by a user through the bills](HE176322_J1SP0060_CalculateBill/HUONG-DAN.md) | Dễ | constants · controller · dto · main · model · service · utils · view | 11 | — | ✅ |
| 25 | `J1.S.P0063` | [Input and display Person Info](HE176322_J1SP0063_PersonInfo/HUONG-DAN.md) | Dễ | constants · controller · dto · main · model · service · utils · view | 10 | — | ✅ |
| 26 | `J1.S.P0062` | [Create a program to analyze file path](HE176322_J1SP0062_AnalyzeFilePath/HUONG-DAN.md) | Dễ | constants · controller · dto · main · model · service · utils · view | 10 | — | ✅ |
| 30 | `J1.S.P0064` | [Check data format](HE176322_J1SP0064_CheckDataFormat/HUONG-DAN.md) | Dễ | constants · controller · dto · main · model · service · utils · view | 10 | — | ✅ |
...
| 37 | `J1.S.P0068` | [Input, sort and display student information](HE176322_J1SP0068_StudentCollectionSort/HUONG-DAN.md) | Dễ | constants · controller · dto · main · model · service · utils · view | 11 | Strategy | ✅ |
| 39 | `J1.S.P0067` | [Analyze the user input string](HE176322_J1SP0067_AnalyzeString/HUONG-DAN.md) | Dễ | constants · controller · dto · main · model · service · utils · view | 10 | — | ✅ |
| 40 | `J1.S.P0001` | [Bubble sort algorithm](HE176322_J1SP0001_BubbleSort/HUONG-DAN.md) | Dễ | constants · controller · dto · main · model · service · utils · view | 10 | — | ✅ |
| 40 | `J1.S.P0002` | [Selection sort algorithm](HE176322_J1SP0002_SelectionSort/HUONG-DAN.md) | Dễ | constants · controller · dto · main · model · service · utils · view | 10 | — | ✅ |
| 40 | `J1.S.P0003` | [Insertion sort algorithm](HE176322_J1SP0003_InsertionSort/HUONG-DAN.md) | Dễ | constants · controller · dto · main · model · service · utils · view | 10 | — | ✅ |
...
| 42 | `J1.S.P0061` | [Create a program to calculate perimeter and area](HE176322_J1SP0061_ShapeCalculator/HUONG-DAN.md) | Dễ | constants · controller · dto · main · model · service · utils · view | 13 | — | ✅ |
...
| 50 | `J1.S.P0008` | [Letter and character count](HE176322_J1SP0008_LetterCharacterCount/HUONG-DAN.md) | Trung bình | constants · controller · dto · main · model · service · utils · view | 10 | — | ✅ |
| 50 | `J1.S.P0009` | [Fibonacci](HE176322_J1SP0009_Fibonacci/HUONG-DAN.md) | Trung bình | constants · controller · dto · main · model · service · view | 8 | — | ✅ |
| 50 | `J1.S.P0010` | [Linear search](HE176322_J1SP0010_LinearSearch/HUONG-DAN.md) | Trung bình | constants · controller · dto · main · model · service · utils · view | 10 | — | ✅ |
...
| 60 | `J1.S.P0082` | [Playing cards](HE176322_J1SP0082_PlayingCards/HUONG-DAN.md) | Trung bình | constants · controller · dto · main · model · service · view | 11 | — | ✅ |
| 60 | `J1.S.P0084` | [Large number](HE176322_J1SP0084_LargeNumber/HUONG-DAN.md) | Trung bình | constants · controller · dto · main · model · service · utils · view | 10 | — | ✅ |
| 61 | `J1.S.P0051` | [Develop a computer program](HE176322_J1SP0051_CalculatorBMI/HUONG-DAN.md) | Trung bình | constants · controller · dto · main · model · service · utils · view | 14 | — | ✅ |
| 63 | `J1.S.P0066` | [Car showroom](HE176322_J1SP0066_CarShowroom/HUONG-DAN.md) | Trung bình | constants · controller · dto · exceptions · main · model · service · utils · view | 15 | Strategy | ✅ |
...
| 70 | `J1.S.P0004` | [Quick sort algorithm](HE176322_J1SP0004_QuickSort/HUONG-DAN.md) | Trung bình | constants · controller · dto · main · model · service · utils · view | 12 | Strategy | ✅ |
| 70 | `J1.S.P0005` | [Merge sort algorithm](HE176322_J1SP0005_MergeSort/HUONG-DAN.md) | Trung bình | constants · controller · dto · main · model · service · utils · view | 12 | Strategy | ✅ |
| 70 | `J1.S.P0006` | [Binary search algorithm](HE176322_J1SP0006_BinarySearch/HUONG-DAN.md) | Trung bình | constants · controller · dto · main · model · service · utils · view | 12 | Strategy | ✅ |
| 70 | `J1.S.P0007` | [Undirected graphs representation](HE176322_J1SP0007_UndirectedGraph/HUONG-DAN.md) | Trung bình | constants · controller · dto · main · model · service · utils · view | 11 | — | ✅ |
| 70 | `J1.S.P0056` | [Program to manage worker information](HE176322_J1SP0056_WorkerManagement/HUONG-DAN.md) | Trung bình | constants · controller · dto · main · model · repository · service · utils · view | 18 | Strategy | ✅ |
| 70 | `J1.S.P0065` | [Check data format](HE176322_J1SP0065_StudentMarkStatistics/HUONG-DAN.md) | Trung bình | constants · controller · dto · main · model · service · utils · view | 14 | Strategy, Builder | ✅ |
| 72 | `J1.S.P0050` | [Solving the equation, find the square numbers, even numbers,](HE176322_J1SP0050_EquationSolver/HUONG-DAN.md) | Trung bình | constants · controller · dto · main · model · service · utils · view | 13 | Template Method | ✅ |
...
| 73 | `J1.S.P0059` | [The program handles files](HE176322_J1SP0059_FileProcessing/HUONG-DAN.md) | Trung bình | constants · controller · dto · main · model · service · utils · view | 13 | Strategy | ✅ |
| 90 | `J1.S.P0080` | [Shapes](HE176322_J1SP0080_Shapes/HUONG-DAN.md) | Trung bình | constants · controller · dto · main · model · service · view | 18 | Factory | ✅ |
...
| 100 | `J1.S.P0011` | [Change base number system (16, 10, 2) program](HE176322_J1SP0011_ChangeBaseNumber/HUONG-DAN.md) | Khó | constants · controller · dto · main · model · service · utils · view | 13 | Strategy | ✅ |
...
| 100 | `J1.S.P0074` | [Write a calculator program (from DCPS’s project)](HE176322_J1SP0074_MatrixCalculator/HUONG-DAN.md) | Khó | constants · controller · dto · main · model · service · utils · view | 17 | Factory | ✅ |
| 100 | `J1.S.P0075` | [Handle file program (extraction from CBDT project)](HE176322_J1SP0075_HandleFile/HUONG-DAN.md) | Khó | constants · controller · dto · main · model · service · utils · view | 13 | — | ✅ |
...
| 100 | `J1.S.P0077` | [Writing module to list and search file by content (CBDT proj](HE176322_J1SP0077_SearchFileByContent/HUONG-DAN.md) | Khó | constants · controller · dto · main · model · service · utils · view | 13 | — | ✅ |
...
| 150 | `J1.S.P0070` | [Login system of the Tien Phong Bank’s Ebank](HE176322_J1SP0070_EbankLogin/HUONG-DAN.md) | Khó | constants · controller · dto · main · model · service · utils · view | 10 | — | ✅ |
| 150 | `J1.S.P0071` | [Task management program of CCRM project](HE176322_J1SP0071_TaskManagement/HUONG-DAN.md) | Khó | constants · controller · dto · main · model · repository · utils · view | 13 | Builder | ✅ |
...
| 500 | `J1.L.P0013` | [The Vehicle Management](HE176322_J1LP0013_VehicleManagement/HUONG-DAN.md) | Khó | constants · controller · dto · main · model · repository · service · utils · view | 23 | Strategy, Factory, Template Method | ✅ |
