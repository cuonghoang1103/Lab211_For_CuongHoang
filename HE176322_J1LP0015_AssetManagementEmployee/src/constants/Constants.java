...
public final class Constants {
    ...
    // Function 3: borrow the assets.
    public static final int MENU_BORROW = 3;

    // Function 4: cancel request.
    public static final int MENU_CANCEL = 4;

    // Function 5: return asset.
    public static final int MENU_RETURN = 5;
    ...
    // ----- ids and dates -----
    // First letter of a request id.
    public static final String REQUEST_PREFIX = "R";

    // A new id: prefix and a 3-digit number, e.g. R008.
    ...
    // ----- number limits -----
    // Smallest quantity to borrow.
    public static final double MIN_BORROW_QUANTITY = 1;

    // Largest quantity to borrow.
    ...
    // Request / borrow row of one employee: id, asset, asset name, qty, date.
    public static final String TRANSACTION_ROW = "%-7s%-7s%-22s%5s  %s";
