...
public final class Constants {
    ...
    // Marks that end a sentence: the brief names the dot; ? and ! count too, so no "?." is
    // added at the end and the word after a question is raised as well.
    ...
    // spaces, no final dot.
    public static final String[] SAMPLE_LINE_ARRAY = {
