...
public final class Message {
    ...
    // The brief's question after the tenth student.
    ...
    // Prompt for a new name; %s is the current name.
    public static final String INPUT_NEW_NAME = "Enter new student name (blank to keep %s): ";
    // Prompt for a new semester; %d is the current semester.
    public static final String INPUT_NEW_SEMESTER = "Enter new semester (blank to keep %d): ";
    // Prompt for a new course; %s is the current course.
    public static final String INPUT_NEW_COURSE = "Enter new course name (blank to keep %s): ";
    ...
    // Fewer than 10 students so far; %d the minimum, %d the count.
