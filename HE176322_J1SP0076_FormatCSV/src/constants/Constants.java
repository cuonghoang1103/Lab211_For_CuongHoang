...
public final class Constants {
    ...
    // A row written back in the brief's form "1, Nguyen Van A, anv@gmail.com, ...": the
    // five columns joined by ", " (String.format, not + - checklist 3.8).
    public static final String CUSTOMER_FORMAT = "%s, %s, %s, %s, %s";
