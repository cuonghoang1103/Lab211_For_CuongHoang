...
public final class Constants {
    ...
    // A zip name the user typed without the extension, then ".zip".
    public static final String ZIP_NAME_FORMAT = "%s.zip";

    // A folder path followed by the separator of the system ("/" or "\").
    public static final String FOLDER_FORMAT = "%s%s";

    // How a job reads in the debugger: source -> destination.
    public static final String JOB_FORMAT = "%s -> %s";
