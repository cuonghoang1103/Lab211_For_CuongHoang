...
/**
 * MD5 of a text, the hash employee.dat stores (MD5 of 123456 is e10adc39...). Login hashes
 * what was typed and compares the hashes: there is no way back from a hash.
 *
 * @author HE176322
 */
public final class MD5Utils {
    ...
    public static String hash(String text) {
        ...
        try {
            byte[] digest = MessageDigest.getInstance(Constants.MD5_ALGORITHM)
